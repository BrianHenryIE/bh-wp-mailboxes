...
class ImapEngine_Email_Fetcher_Integration_Test extends Unit_Testcase {
	...
	public function test_mark_email_read_on_server(): void {
		...
		$sut = new ImapEngine_Imap_Email_Provider( $this->settings, $this->logger );
	...
	public function test_bad_server(): void {
		...
		$exception = null;
		try {
			$imap = new ImapEngine_Imap_Email_Provider( $settings, $logger );
	...
	public function test_bad_password(): void {
		...
		$exception = null;
		try {
			$fetcher = new ImapEngine_Imap_Email_Provider( $settings, $logger );
