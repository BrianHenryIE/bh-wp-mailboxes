<?php
/**
 * Tests for BH_WP_Emails main setup class. Tests the actions are correctly added.
 *
 ...
 * Class Develop_Test
 */
class BH_WP_Emails_Integration_Test extends \Codeception\TestCase\WPTestCase {
