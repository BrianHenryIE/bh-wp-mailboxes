<?php
/**
 * Tests for BH_WP_Mailboxes main setup class. Tests the actions are correctly added.
 *
 ...
 * Class Develop_Test
 */
class BH_WP_Mailboxes_Hooks_Integration_Test extends \Codeception\TestCase\WPTestCase {
