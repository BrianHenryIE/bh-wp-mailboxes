 ...
 * Class Admin_Test
 *
 * @coversDefaultClass \BH_WP_Emails\Admin\Admin
 */
class Admin_Test extends \Codeception\Test\Unit {
	 ...
	 */
	private $plugin_name = 'bh-wp-emails';
	...
	public function test_enqueue_styles() {
		...
		$css_file = $plugin_root_dir . '/admin/css/bh-wp-emails-admin.css';
	...
	public function test_enqueue_scripts() {
		...
		$src       = $plugin_root_dir . '/admin/js/bh-wp-emails-admin.js';
		$deps      = array( 'jquery' );
		$ver       = $this->version;
		$in_footer = true;
